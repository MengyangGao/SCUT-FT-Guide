...
\textbf{2. 使用偏振光旋光测试仪测量葡萄糖溶液的旋光率和浓度}
...
B. 马吕斯定律验证：通过测量不同角度下的光强，我们验证了马吕斯定律$I = I_0\cos^2\theta$。实验数据与理论预测具有良好的符合性，相关系数$R^2 = 0.9943$。

C. 从旋光角度的变化可以判断葡萄糖是右旋物质，这与已知的葡萄糖性质相符。
